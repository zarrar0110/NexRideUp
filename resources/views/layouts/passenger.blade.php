...
<head>
    ...
    <title>@yield('title', 'Passenger Dashboard') - NexRide</title>
            ...
            <div class="col-md-3 col-lg-2 px-0">
                <div class="sidebar">
                    <div class="p-3 text-center">
                        <h4 class="text-white mb-0" style="font-weight: bold; font-size: 2rem; background: linear-gradient(90deg, #36d1c4 0%, #1e3799 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; text-shadow: 1px 1px 8px rgba(30,55,153,0.2); letter-spacing: 2px;">NexRide</h4>
                        <small class="text-white-50" style="font-weight: 600; letter-spacing: 1px;">Passenger Portal</small>
                    </div>
                    <hr class="text-white-50">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('passenger/dashboard') ? 'active' : '' }}" href="/passenger/dashboard">
                                <i class="fas fa-tachometer-alt me-2"></i> Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('passenger/trip-requests*') ? 'active' : '' }}" href="/passenger/trip-requests">
                                <i class="fas fa-route me-2"></i> My Trip Requests
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('passenger/trip-requests/create') ? 'active' : '' }}" href="/passenger/trip-requests/create">
                                <i class="fas fa-plus me-2"></i> Request New Trip
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('passenger/trips*') ? 'active' : '' }}" href="/passenger/trips">
                                <i class="fas fa-car me-2"></i> My Trips
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('passenger/payments*') ? 'active' : '' }}" href="/passenger/payments">
                                <i class="fas fa-credit-card me-2"></i> Payments
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('passenger/reviews*') ? 'active' : '' }}" href="/passenger/reviews">
                                <i class="fas fa-star me-2"></i> Reviews
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('passenger/profile*') ? 'active' : '' }}" href="/passenger/profile">
                ...
                <div class="main-content">
                    ...
                    <nav class="top-navbar p-3 mb-0">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">@yield('title', 'Passenger Dashboard')</h5>
                            <div class="d-flex align-items-center">
                                <span class="me-3">Welcome, {{ auth()->user()->name ?? 'Passenger' }}</span>
                    ...
                    <div id="mainSlider" class="carousel slide mb-4" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="carousel-caption d-none d-md-block">
                                    <h5>Tip: Rate Your Driver</h5>
                                    <p>Your feedback helps us improve every ride.</p>
                                </div>
                            </div>
                            <div class="carousel-item">
